...
static void process_image(void *p, size_t  size)
{
        if (out_buf)
...
static void init_device(void)
{
        ...
        fmt.fmt.pix.width = 100;
        fmt.fmt.pix.height = 100;
...
int main(int argc, char **argv)
{
        ...
        //server.sin_addr.s_addr=inet_addr("192.168.43.168"); //gnani
        //server.sin_addr.s_addr=inet_addr("192.168.43.149");
        server.sin_addr.s_addr=inet_addr("192.168.43.178"); //mahith
        //server.sin_addr.s_addr=inet_addr("172.16.137.50");
